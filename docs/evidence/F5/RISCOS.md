...
- `[EXECUTADO PELO USUÁRIO · 2026-09-24]` a validação de Conventional Commits rejeitou o subject padrão criado por `git revert --no-edit` no commit auditado `87fa002`; o gate foi restringido a uma exceção exata para esse único commit legado, sem afrouxar a regra para commits novos.
