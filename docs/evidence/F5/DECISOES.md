...
- `[VERIFICADO: desafio técnico, Entrega · 2026-09-24]` o GitHub público é o remoto obrigatório da entrega; o GitLab é mantido somente como espelho secundário e sua indisponibilidade não bloqueia os gates F5.
- `[VERIFICADO · 2026-09-24]` gates executados através de `tee` devem propagar o exit code real; os scripts F5 encerram com `exit "$STATUS"` e o roteiro usa `bash -o pipefail`.
