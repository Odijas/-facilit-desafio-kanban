...
| **F3-L2** | **Autenticação do responsável + erro seguro** | próximo lote |
| F3-L3 | Observabilidade (antigo F3-L2) | não iniciado |
| F3-L4 | Engenharia de entrega (antigo F3-L3), com migração para o GitHub | não iniciado |
